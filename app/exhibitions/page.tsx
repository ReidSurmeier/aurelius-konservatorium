        ...
        {current[0] && (
          <div className="grid md:grid-cols-[3fr_2fr] gap-10 mb-12 pb-12 border-b border-[#e0e0dc]">
            <div className="relative aspect-[16/9] overflow-hidden bg-[#e8e6e1]">
              <ImageWithFallback src={`/images/${current[0].imageFile}`} alt={current[0].title} fill priority fallbackText={current[0].title} />
            </div>
      ...
      {online.length > 0 && (
        <section className="border-t border-[#e0e0dc] py-14 px-6 max-w-screen-xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {online.map((ex) => (
              <div key={ex.slug} className="border border-[#e0e0dc] p-6 hover:border-[#c5a028] transition-colors">
                <p className="label-caps text-[#c5a028] mb-3">Online &middot; Permanently Accessible</p>
