...
export const artworks: Artwork[] = [
  // ── SCULPTURES ──────────────────────────────────────────────────────────────
  {
    ...
    year: 2021,
    artist: "Unknown sculptor, commissioned by the Zuckerberg Chan Initiative",
    medium: "Cast bronze on marble pedestal",
    dimensions: "94 × 38 × 38 cm",
    acquisition: "Long-term loan from the Zuckerberg Chan Initiative, 2022",
    catalogNo: "AKU-2022-041",
    category: "sculpture",
    curatorNote: "This monumental bust marks a turning point in the history of corporate patronage. Commissioned by the founder and CEO of Meta Platforms Inc. as a personal tribute to his wife, the work unites classical portrait tradition with the calculated self-presentation of the digital age. The patination follows antique models with precision, while the facial features are rendered with photorealistic accuracy — a process reminiscent of the commissioned portraits of Florentine banking families.",
    imageFile: "priscilla-2021.jpg",
    exhibition: "Corporate Bodies: Sculpture and Power"
  },
  {
    slug: "bezos-apres-matisse",
    title: "Bezos après Matisse (The Free Form)",
    year: 2019,
    artist: "Kollektiv Kapitalschnitt, Berlin",
    medium: "Cut paper, aluminum armature, Plexiglas vitrine",
    dimensions: "180 × 120 × 12 cm",
    acquisition: "Purchased from the estate of Galerie Nullwachstum, Hamburg, 2021",
    catalogNo: "AKU-2021-033",
    category: "sculpture",
    featured: true,
    curatorNote: "In conscious homage to Henri Matisse's late paper-cut period, Kollektiv Kapitalschnitt deconstructs the master's biomorphic forms and replaces them with the organic geometry of corporate structure. The silhouetted figures — recognizably modeled on the Amazon founder — merge with abstract trading charts to create a work that reads corporate balance sheets as body language.",
    imageFile: "bezos-apres-matisse.jpg"
  },
  {
    slug: "die-gefaehrtinnen",
    title: "The Companions — A Greek Frieze",
    year: 2022,
    artist: "Studio Marmorblut, Athens / Berlin",
    medium: "Pentelic marble, hand-carved",
    dimensions: "320 × 80 × 22 cm",
    acquisition: "Purchased with funds from the Federal Cultural Promotion Fund, 2023",
    catalogNo: "AKU-2023-007",
    category: "sculpture",
    curatorNote: "The frieze adapts the formal language of the Parthenon frieze for a contemporary subject: the succession of Elon Musk's life partners, arranged in chronological order and dressed in classical drapery. The work consciously cites the ancient tradition of legitimizing and monumentalizing ruling dynasties through relief sculpture — and asks what it means when this logic of legitimation is applied to technology executives in the 21st century.",
  ...
  },
  {
    ...
    title: "The Oracle",
    year: 2011,
    artist: "Realized posthumously by the AKU Atelier, 2012",
  ...
  // ── PAINTINGS ───────────────────────────────────────────────────────────────
  {
    ...
    year: 2018,
    artist: "Artists' Collective Dividende, Frankfurt",
  ...
  },
  {
    ...
    year: 2016,
    artist: "AKU Atelier after a design by Studio Nullpunkt",
  ...
  },
  {
    ...
    year: 2023,
    artist: "Studio Barock Digital, Munich",
  ...
  },
  {
    ...
    year: 2019,
    artist: "Painting Collective Transparenz, Hamburg",
  ...
  // ── EPHEMERA & OBJECTS ───────────────────────────────────────────────────
  {
    ...
    year: 2024,
    artist: "Atelier Brillant, Geneva / Menlo Park",
  ...
  },
  {
    ...
    year: 2023,
    artist: "Goldsmith Atelier Augen, Pforzheim",
  ...
  // ── ADDITIONAL WORKS ─────────────────────────────────────────────────────
  {
    ...
    year: 2023,
    artist: "Algorithmic Atelier, autonomous",
  ...
  },
  {
    ...
    year: 2024,
    artist: "Textile Collective Warp and Weft, Brussels",
  ...
  },
  {
    ...
    year: 2019,
    artist: "Icon Painting Atelier Byzantium, Thessaloniki",
  ...
  },
  {
    ...
    year: 2020,
    artist: "Atelier Neoklassik, Vienna",
    medium: "Oil on canvas",
  ...
  },
  {
    ...
    year: 2021,
    artist: "Cartographic Institute for Digital Geography, Zurich",
